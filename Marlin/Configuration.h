...
#define STRING_CONFIG_H_AUTHOR "(leyfear, MMS Yazici)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME __DATE__
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // E3D V6 Clone - find with m303s210c10
...
// ANDERS
    #define  DEFAULT_bedKp 223.26
    #define  DEFAULT_bedKi 39.16
    #define  DEFAULT_bedKd 318.24
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE          {225, 225, 3, 40}
